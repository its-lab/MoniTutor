...
response.logo = A(B(SPAN('M'),'oni',SPAN('T'),'utor', I(" alpha", _style="color: red; font-size: small;")),
...
response.meta.author = 'Mark Swillus <mark.swillus@fh-aachen.de>'
response.meta.description = 'MoniTutor - Helping students in workshops, since 2016'
response.meta.keywords = 'Tutor, hands-on, workshop, monitoring, icinga, Fh-aachen'
response.meta.generator = 'MoniTutor'
